...
def main(path_tc, extra_library_names, extra_library_types, output_dir):
    ...
    with Pool(processes=2) as p: # Adjust to your likeing, 2 is standard, but every configuration is stable and save (tested up to 8, remember that your cpu is really loaded the more you put, mine was often over 70%, sometimes over 80% and rarely at 100%)
